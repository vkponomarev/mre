...
<div class="wrap wrap-header">
    ...
    <div class="header-top-line">
        ...
        <a href="/" rel="nofollow" class="header-top-line-site-name-link">MRELECTRIK</a>
        ...
        <div id="navbar" class="navbar-collapse collapse nav-bar-collapsed ">
            ...
            <ul class="nav navbar-nav nav-bar-collapsed-ul">
                ...
                <li class="nav-link navbar-li">
                    ...
                    <a href="/services/" class="dropdown-toggle navbar-a-link">
...
<footer>
    ...
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <ul class="contact">
                <span><?= Yii::t('app', 'MRELECTRIK.RU') ?></span>
