...
use common\components\subDomain\SubDomainCheck;
use Yii;
...
class MainPagesData
{
    ...
    function __construct($givenUrl, $tableName)
    {
        ...
        //(new \common\components\dump\Dump())->printR($subDomainCheck);
        $this->contacts($subDomainCheck);
    ...
    function contacts($subDomainCheck)
    {

        (new MainPagesDataContacts())->contacts($subDomainCheck);
